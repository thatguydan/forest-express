        ...
        if (field.integration) {
          ...
          if (_.isPlainObject(field.type)) {
            ...
            if (_.isArray(field.type) && !fieldReference && referenceSchema.isVirtual) {
              if (_.find(referenceSchema.fields, innerField => innerField.field === 'id')) {
                fieldReference = 'id';
              } else {
            ...
            _.each(referenceSchema.fields, (innerField) => {
              detectFieldWithSpecialFormat(innerField, fieldName);
            });
